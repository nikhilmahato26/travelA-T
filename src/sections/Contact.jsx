          ...
          <ScrollReveal direction="left" className="lg:col-span-2">
            <div className="space-y-6">
              ...
              <div className="bg-navy-900 text-white p-7">
                ...
                <h3 className="font-display font-bold text-lg text-white mb-5">Our Offices</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <FiMapPin size={16} className="text-gold-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-gold-300">Head Office</p>
                      <p className="text-white text-sm font-medium mb-0.5">Delhi, India</p>
                      <p className="text-navy-300 text-xs leading-relaxed">Central operations & domestic/international tours</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <FiMapPin size={16} className="text-gold-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-gold-300">Branch Office</p>
                      <p className="text-white text-sm font-medium mb-0.5">Srinagar, Jammu and Kashmir, India</p>
                      <p className="text-navy-300 text-xs leading-relaxed">Kashmir, Ladakh & mountain tour operations</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 pt-2 border-t border-navy-800">
              ...
              <div className="bg-white border border-gray-100 p-6 shadow-card">
                ...
                {[
                  "Best price guarantee & transparent billing",
                  "Free itinerary customisation",
                  "Local presence in Delhi & Srinagar",
                  "24/7 travel coordination support",
                  ...
                  <div key={point} className="flex items-center gap-2.5 mb-2.5">
                    <div className="w-4 h-4 bg-gold-gradient flex items-center justify-center flex-shrink-0">
                      <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                        <path d="M1 4L3 6L7 2" stroke="#1f1713" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
