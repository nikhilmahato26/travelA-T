          ...
          <div className="lg:col-span-2">
            <ScrollReveal>
              ...
              <p className="text-navy-600 text-base leading-relaxed mb-8">
                Everything you need to know before booking your dream journey with {brand.name}.
              </p>
              ...
              <div className="p-6 bg-navy-50 border-l-4 border-gold-500">
                ...
                <p className="text-navy-500 text-sm mb-4">Our travel experts in Delhi and Srinagar are available Mon–Sat, 9:30 AM – 7:30 PM.</p>
                <a
                  href={`https://wa.me/${brand.whatsapp}?text=${encodeURIComponent("Hi! I have a question about booking a travel package with Travel with A & T.")}`}
                  target="_blank"
